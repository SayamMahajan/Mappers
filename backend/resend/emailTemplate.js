      ...
      <tr>
        <td style="text-align:center">
          ...
          <p style="font-size:16px;color:#555;margin:20px 0">
            Welcome to Mappers! Use the verification code below to activate your account:
          </p>
          <p
    ...
    >
      <tr>
        <td style="text-align:center">
          ...
          <p style="font-size:16px;color:#555;margin:20px 0">
            Congratulations! Your Mappers account has been successfully verified.
          </p>
        </td>
      </tr>
    </table>
    ...
    >
      <tr>
        <td style="text-align:center">
          ...
          <p style="font-size:16px;color:#555;margin:20px 0">
            Click the link below to reset your Mappers account password:
          </p>
    ...
    >
      <tr>
        <td style="text-align:center">
          ...
          <p style="font-size:16px;color:#555;margin:20px 0">
            Your Mappers account password has been reset successfully.
          </p>
        </td>
      </tr>
    </table>
